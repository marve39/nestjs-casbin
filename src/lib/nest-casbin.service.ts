...
import { Enforcer, Filter, Watcher, Effector, Util } from 'casbin';
...
export class NestCasbinService {
  ...
  public async enforceEx(params: string[]): Promise<[boolean, string[]]> {
  ...
  public async getRoles(
    ...
    //this.enforcer.addNamedMatchingFunc('g', Util.keyMatchFunc);
    const e = this.enforcer.getRoleManager()
    console.log(e);
    console.log(3)
    console.log(name)
    return e.getRoles(name);
  }
